...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, des, val) {
            ...
            // Create new item based on 'inc' or 'exp' tyoe
            if (type === 'exp'){
        ...
        deleteItem: function(type, id) {
            ...
            // id = 3
            // data.allItems[type][id] - doesnt work
            // ids = [1 2 4 6 8]
            // index = 3
            ...
            if (index !== -1) {
                // splice is used to remove elements, slice to create a copy
        ...
        calculateBudget: function() {
            ...
            // 3. Calculate percentage of income used by expenses
...
var UIController = (function() {
    ...
    return {
        ...
        deleteListItem: function(selectorID) {
            // In JS we cant delete an element but have to delete the child
        ...
        clearFields: function() {
            ...
            // fields is a list right now, need to use call method to convert to array
